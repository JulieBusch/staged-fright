...
class AudioSession extends Component {
    constructor(props) {
        ...
        // Used for summary page metrics
        this.volumeDataArr =[];
        this.pitchDataArr = [];
        this.semitoneDataArr = [];
    }
    ...
    processVolume = (context, stream) => {
        ...
        console.log('We are about to modify the ARRAAAAY!');
        ...
        this.meterInterval = setInterval(() => {
            ...
            // console.log('This is the caller: ', arguments.callee.caller.toString());
            this.volumeDataArr.push(soundMeter.slow.toFixed(2));
            this.pitchDataArr.push(this.pitch);
        }, 200);
      });
    }
    ...
    processPitch = (context, stream) => {
        ...
        this.pitchInterval = setInterval(() => {
            ...
            this.semitoneDataArr.push(stdSemi);
    ...
    sendDataArrays = () => {
        this.props.syncVolumeData(this.volumeDataArr);
        // this.props.syncPitchData(this.pitchDataArr);
        // this.props.syncSemitoneData(this.semitoneDataArr);
    }

    componentWillReceiveProps(nextProps) {
        console.log('We are receiving props!!!')
        if (nextProps.recording && !this.state.recording) {
            console.log('We are inside IF!!! Here is this.state.recording: ', this.state.recording);
            this.startRecording();
        } else {
